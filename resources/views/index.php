        ...
        <div class="category">
            ...
            <?php foreach ($data['categories'] as $category) { ?>
                <article class="category__item">
                    ...
                    <a href="/category" class="category__title category__title--brown"><?= $category['name']?></a>
                </article>
            <?php } ?>
        ...
        if (!empty($books)) {?>
            <section>
                <header class="header">
                    ...
                    <a href="/category?id=<?= $category['id'] ?>" class="header__link">عرض الكل</a>
                </header>
                <div class="category category--gap">
                    <div class="category__prev">
                        <a href="#"><img src="images/icon/arrow.svg" alt="السابق"></a>
                    ...
                    foreach ($books as $book){ ?>
                        <article class="card">
                            <a href="/details"><img src="/uploads/<?= $book['image'] ?>" class="card__img" alt="صورة الكتاب"></a>
                            <div class="card__info">
                                <div class="book-type">
                                    <img src="images/icon/type.svg" class="book-type__icon" alt="نوع الكتاب">
                                    <h1><?= $book['format'] ?></h1>
                                ...
                                <div class="book-title">
                                    <h1><a href="/details" class="book-title__item"><?= $book['title'] . "(" . $book['format'] . ")" ?></a></h1>
                                </div>
                                <div class="book-price">
